...
USE_TZ = True  # Keeps timezone handling consistent
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'aryanpatel6966@gmail.com'
EMAIL_HOST_PASSWORD = 'qdvl xiwp jwxl zyzc'  # use an app password, not your Gmail password
